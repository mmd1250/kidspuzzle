...
public class FallinParts5tike : MonoBehaviour
{
    public GameObject part1Shadow;
    public GameObject part2Shadow;
    public GameObject part3Shadow;
    public GameObject part4Shadow;
    public GameObject part5Shadow;
    ...
    public GameObject MainPart4;
    public GameObject MainPart5;
    ...
    void Start()
    {
        ...
        part4.transform.position = part4Shadow.transform.position;
        part5.transform.position = part5Shadow.transform.position;
    ...
    IEnumerator FallTimer()
    {
        ...
        LeanTween.move(part4, MainPart4.transform.position, 1.2f).setEase(LeanTweenType.easeInOutQuad);
        LeanTween.move(part5, MainPart5.transform.position, 1.2f).setEase(LeanTweenType.easeInOutQuad)
            ...
            .setOnComplete(() => // ????? ????? ???? ???? ?? ??? ????? ???? ??
            {
                ...
                MainPart4.GetComponent<SpriteRenderer>().enabled = true;
                MainPart5.GetComponent<SpriteRenderer>().enabled = true;
            });
