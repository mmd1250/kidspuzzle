...
public class part4 : MonoBehaviour
{
    ...
    public static bool locked4;
    public static bool touchLockPart4;
    ...
    void Update()
    {
        ...
        if (Input.touchCount > 0 && !locked4 && !touchLockPart4)
        {
