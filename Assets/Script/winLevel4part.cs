...
public class winLevel4part : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (part1.locked1 && part2.locked2 && part3.locked3 && part4.locked4 && pauseHelper == 0)
        {
            GameController4tike.pauseHelper = 1;
            ...
            if (starHelper == 1)
            {
                ...
                PlayerPrefs.SetInt("Star", PlayerPrefs.GetInt("Star", 0) + 4);
            }
